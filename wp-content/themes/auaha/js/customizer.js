jQuery(document).ready(function ($) {
    ...
    $(document).on('tinymce-editor-init', function (event, editor) {
        editor.on('change', function (e) {
            ...
            //console.log(event)
            wp.customize(editor.id, function (settings) {
                settings.set(editor.getContent())
            ...
            //wp.customize.control( editor.id ).focus()
    ...
    /* wp.customize('header_title', function (setting) {
        console.log(`get settings`, setting)
        setting.bind(function (pageId) {
            console.log('Bindei aqui', document.querySelector('.headerTitle'))
        })
    }) */
