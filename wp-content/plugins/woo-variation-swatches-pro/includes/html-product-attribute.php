                        ...
                        <td class="wvs-pro-variable-swatches-tax-wrapper-td" colspan="2">
							...
							<?php foreach ( $wvs_pro_attribute[ 'terms' ] as $term_id => $term ): ?>
								...
								if ( isset( $saved_product_attributes[ $attribute_key ] ) ) {
									...
									$saved_term_is_dual_color   = isset( $saved_product_attributes[ $attribute_key ][ 'terms' ][ $term_id ] ) ? $saved_product_attributes[ $attribute_key ][ 'terms' ][ $term_id ][ 'is_dual_color' ] : '';
									$saved_term_secondary_color = isset( $saved_product_attributes[ $attribute_key ][ 'terms' ][ $term_id ] ) ? $saved_product_attributes[ $attribute_key ][ 'terms' ][ $term_id ][ 'secondary_color' ] : '';
